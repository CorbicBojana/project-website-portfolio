...
$(".slider_inner").mousemove(function(e) {
  if (dragging) {
    ...
    $(".slider_inner").css(
      "transform",
      "translateX(".concat(difference + endPosition, "px) translateY(120px)")
    );
  }
});
var offset = 760;
...
$(".slider_inner").mouseup(function() {
  cursor.style.transition = "transform "
    .concat(cursorSettings.transitionTime, " ")
    .concat(cursorSettings.transitionEase, ", width ")
    .concat(cursorSettings.expandSpeed, "s .2s, height ")
    .concat(cursorSettings.expandSpeed, "s .2s, opacity 1s .2s");
  ...
  if (difference < -160) {
    ...
    if (index < 3) {
      ...
      $(".slider_inner").css(
        "transform",
        "translateX(".concat(threshold, "px) translateY(120px)")
      );
...
function dynamicCursor(options) {
  ...
  cursor.style.transition = "transform "
    .concat(options.transitionTime, " ")
    .concat(options.transitionEase, ", width ")
    .concat(options.expandSpeed, "s .2s, height ")
    .concat(options.expandSpeed, "s .2s, opacity 1s .2s");
  cursor.style.border = ""
    .concat(options.borderWidth, "px solid ")
    .concat(options.borderColor);
  ...
  document.onmousemove = function(e) {
    ...
    cursor.style.top = "0";
    cursor.style.left = "0";
    cursor.style.transform = "translateX(calc("
      .concat(x, "px - 50%)) translateY(calc(")
      .concat(y, "px - 50%))");
  };
